...
export default function Home() {
 ...
 title: "Brand Kits", 
 slug: "brand-kits",
 desc: "A unified visual system so your business looks credible everywhere.",
 bullets: ["Strict typography hierarchy and font selection", "Exact color value systems (Hex, RGB, HSL)", "Premium micro-interactions and animations"],
 icon: (
 <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>

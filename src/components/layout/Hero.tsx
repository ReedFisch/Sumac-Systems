...
const Hero = () => {
 ...
 <Image src="/images/sumac/image9.webp" alt="" fill sizes="350px" className="object-contain scale-x-[-1]" aria-hidden="true" />
  ...
  {/* Floating Chips (Hero Level) */}
  {/* Lead Card (Top Left) */}
  <motion.div
    initial={{ opacity: 0, y: 40, scale: 0.9 }}
    animate={{ opacity: 1, y: 0, scale: 1 }}
    transition={{ duration: 1.0, delay: 1.2, type: "spring", stiffness: 80, damping: 15 }}
    className="absolute left-4 md:left-[10%] top-[15%] md:top-[22%] bg-white rounded-2xl p-4 shadow-[0_20px_40px_rgba(0,0,0,0.25)] w-[260px] flex gap-4 items-center z-40 font-sans pointer-events-auto hidden md:flex border border-white/10"
  >
  ...
  <motion.div
    ...
    className="absolute right-4 md:right-[8%] top-[40%] md:top-[35%] bg-white rounded-2xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.3)] w-[280px] gap-4 items-center z-30 font-sans pointer-events-auto hidden md:flex border border-white/10"
  >
  ...
  <motion.div
    ...
    className="absolute left-4 md:left-[6%] bottom-[15%] md:bottom-[25%] bg-white rounded-2xl p-5 shadow-[0_30px_60px_rgba(0,0,0,0.4)] w-[280px] z-30 pointer-events-auto hidden md:block border border-white/10"
  >
